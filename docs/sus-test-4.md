...
1. Open the dashboard: [https://limbus-company-nlp-guides.streamlit.app/](https://limbus-company-nlp-guides.streamlit.app/)
...
| ------ | ---------- | -------------------------------- |
| You    | Heathcliff | Kurokumo Clan Wakashu Heathcliff |
...
1. In the menu, select the character: `[Heathcliff]`
2. Select the identity: `[Kurokumo Clan Wakashu Heathcliff]`
